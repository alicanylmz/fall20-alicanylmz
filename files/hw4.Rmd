...
ggplot() + 
  geom_line(data = daily_consumption, aes(x = Date, y = clean_cons)) + ylab('Cleaned mean consumption')
...
After putting the results into the `error_test` function, we observe that WMAPE value of the second model is found to have the lowest WMAPE value. Thus, we can select `ARIMA(2,0,1)(2,0,0)[7]` as the best model among the three.
